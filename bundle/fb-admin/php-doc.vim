...
"let g:pdv_cfg_Author = system("finger `whoami`|head -n1|sed 's/^Login: \(\S*\)\s*Name: \(.*\)/\2 <\1@facebook.com>/")
let g:pdv_cfg_Author = system("whoami|tr -d '\n'")
...
" Whether to generate @access at all (1|0)?
let g:pdv_cfg_do_access = 0

" Whether to guess scopes by the PEAR coding standards:
...
" Whether to prefill the comment with the funcname (or start blank) (1|0)?
let g:pdv_cfg_funcname_for_comment = 0

" Whether to fill in @author for functions (in addition to classes) (1|0)?
let g:pdv_cfg_func_do_author = 1
...
func! PhpDocFunc()
  ...
  let l:comment = g:pdv_cfg_funcname_for_comment == 1 ? l:funcname : ""
  ...
  exe l:txtBOL . g:pdv_cfg_Comment1 . l:comment . " " . g:pdv_cfg_EOL
